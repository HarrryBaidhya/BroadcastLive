...
builder.Services.AddDbContext<ProductCollegeContext>(options => options.UseSqlServer(connectionString));

builder.Services.AddDefaultIdentity<ProductCollegeUser>(options => options.SignIn.RequireConfirmedAccount = true).AddEntityFrameworkStores<ProductCollegeContext>();
